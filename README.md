...
4. Created Dummy Model based on SampleJSON. If Confirmed input coming in Using this Model will be a better approach than using JObject as parameter both from performance as well as cleanliness perspective.
5. 2 Initial methods based on input Json. Parameters to be changed in future, after understanding.
